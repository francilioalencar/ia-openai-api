...
public class OpenIaService {
    ...
    public String gerarConteudoComChatOpenIa(String promptSystem, String promptUser) {
        ...
        if (this.tokenService.contarTokens(promptUser) > 128000) {
            ...
            throw new IllegalArgumentException("A quantidade de Tokens ultrapassa a quantidade de 128K ");
        }
        ...
        try {
            ...
            try {
                ...
                switch (u.getResponseInfo().getStatus()) {
                    ...
                    case 401 -> {
                        return "AuthenticationException (401)";
                    }
                    case 404 -> {
                        return "NotFoundException (404)";
                    }
                    case 422 -> {
                        return "UnprocessableEntityException (422)";
                    }
                    case 429 -> {
                        return "RateLimitException (429)";
                    }
                    default -> {
                        return "UnexpectedStatusCodeException (other status codes)";
                    }
                }
            }
